...
`fg` command is basically to resume the suspended process which we will do in this challenge and get the flag
### Commands Run:
...
```
pwn.college{8YKS8KdDITqadQHASCeEqTPTlG-.QX2QDO0wyMzAzNzEzW}
```
